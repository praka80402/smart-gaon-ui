...
// export default function Weatherdashboard({ layout = "vertical" }) {
//   const [weather, setWeather] = useState(null);
//   const [error, setError] = useState(null);
//   const API_KEY = "b432423c9b34e080da00a78f925da054"; // Replace with your API key
...
//   return (
//     <div className={`weather-widget ${layout === "feed" ? "feed" : ""}`}>
//       <div className="weather-top-feed">
//         <img
//           src={getWeatherIcon(weather.weather[0].main)}
//           alt={weather.weather[0].description}
//           className="weather-icon-feed"
//         />

//         <div className="weather-info-feed">
//           <h2>
//             {Math.round(weather.main.temp)}<sup>°C</sup> | <span>°F</span>
//           </h2>
//           <p>
//             {weather.weather[0].description},{" "}
//             <b>{weather.name || "Your City"}</b>
//           </p>
//         </div>
//       </div>

//       <hr className="weather-divider-feed" />

//       <div className="weather-bottom-feed">
//         <div>
//           🌧️ <p>{weather.rain ? weather.rain["1h"] + "%" : "0%"}</p>
//           <span>Precipitation</span>
//         </div>
...
//         </div>
//         <div>
//           <img src={windIcon} alt="wind" className="mini-icon-feed" />
//           <p>{weather.wind.speed} km/h</p>
//           <span>Wind</span>
//         </div>
//       </div>
